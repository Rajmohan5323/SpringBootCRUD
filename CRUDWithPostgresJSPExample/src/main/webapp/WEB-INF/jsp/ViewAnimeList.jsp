        ...
        <form:form>
            ...
            <table class="table table-bordered">
            	...
            	<c:forEach var="anime" items="${animeList}">
                    <tr>
                		<td>${anime.customerid}</td>
                		<td>${anime.customername}</td>
                		<td>${anime.customerage}</td>
                		<td><button type="button" class="btn btn-success">
                		    <a href="/editAnime/${anime.customerid}">Edit</a>
                		</button></td>
                		<td><button type="button" class="btn btn-danger">
                			<a href="/deleteAnime/${anime.customerid}">Delete</a>
                		</button></td>
                	</tr>
