...
public class AnimeController {
    ...
    public String editAnime(@PathVariable Long customerid, Model model) {
        model.addAttribute("anime", animeService.getAnimeById(customerid));
    ...
    public String editSaveAnime(Anime anime, RedirectAttributes redirectAttributes) {
        ...
        return "redirect:/editAnime/" + anime.getCustomerid();
    }
